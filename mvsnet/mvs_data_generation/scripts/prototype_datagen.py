...
"""
This is a script used to prototype new features / behavior of the data generator.
This is meant to speed up development since testing the datagen in the context of training
takes much longer. That being said, this is not a unit test, or official integration test, and is 
included here for convenience of future prototyping.
